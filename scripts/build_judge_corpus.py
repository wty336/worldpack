...
SEEDS: dict[str, dict] = {
    ...
    "P1_school_letters": {
        ...
        "confab": [
            ("lin_xia", "林夏", "林夏说：『周三广播的稿子我替你留了一栏，你署自己的名字。』"),
            ("lin_xia", "林夏", "林夏道：『那封信是我写的，落款处我等你来问。』"),
            ("lin_xia", "林夏", "林夏说：『旧图书室的钥匙我给你配一把，别跟别人说。』"),
            ("zhou_mu", "周牧", "周牧拍着胸口：『月考我帮你把答案传过去，稳的。』"),
            ("zhou_mu", "周牧", "周牧说：『那封信的事我打听过了，是高二(5)班的人写的。』"),
            ("zhou_mu", "周牧", "周牧凑过来：『我把你的信拿给陈老师看了，你别怪我。』"),
            ("chen_laoshi", "陈老师", "陈老师说：『月考的事我已经跟教务处打过招呼，名次给你留着。』"),
            ("chen_laoshi", "陈老师", "陈老师道：『那封信我看了，落款是林夏，你们自己谈。』"),
            ("lin_xia", "林夏", "林夏说：『我把广播稿的署名换成你了，别推。』"),
            ("zhou_mu", "周牧", "周牧说：『我替你给林夏写了封信，说你不方便当面讲。』"),
        ],
        "ooc": [
