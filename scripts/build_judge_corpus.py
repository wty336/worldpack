...
SEEDS: dict[str, dict] = {
    ...
    "P2_era_dual": {
        ...
        "confab": [
            ("li_zhuren", "李主任", "李主任说：『下个月把你调到机修组，手续我来办。』"),
            ("li_zhuren", "李主任", "李主任拍板：『年底先进生产者的名额，我给你留一个。』"),
            ("wang_dajie", "王大姐", "王大姐说：『你家的细粮票我替你多领了两份，别声张。』"),
            ("wang_dajie", "王大姐", "王大姐说：『陈姨那边我去说，保证让你排上号。』"),
            ("xiao_ma", "小马", "小马说：『那批轴承的事我替你瞒下来了，账我已经改过。』"),
            ("xiao_ma", "小马", "小马说：『我先借你二十块，发薪再还我就行。』"),
            ("chen_yi", "陈姨", "陈姨说：『户口的事我替你跑，三天就能办下来。』"),
            ("chen_yi", "陈姨", "陈姨说：『赵科长的事我已经报上去了，你放心。』"),
            ("lao_sun", "老孙头", "老孙头说：『后门的钥匙我给你留了一把，夜里进出方便。』"),
            ("zhao_kezhang", "赵科长", "赵科长说：『调令我给你签了，你明早去传达室拿。』"),
        ],
        "ooc": [
